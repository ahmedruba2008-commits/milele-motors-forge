  ...
  return (
    <footer id="contact" className="bg-brand-navy border-t border-white/10 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-10 py-16">
          ...
          <div className="mt-5 flex gap-3">
            {[Instagram, Facebook, Youtube].map((Icon, i) => (
              <a
                ...
                className="w-9 h-9 rounded-full border border-white/15 grid place-items-center text-white/40 hover:text-white hover:border-white/40 transition-colors"
              >
                <Icon size={16} />
              </a>
            ))}
        ...
        <div>
          <h4 className="text-white font-syne font-semibold text-sm uppercase tracking-widest mb-4">
            Company
          </h4>
        ...
        <div>
          ...
          <ul className="space-y-3">
            <li>
              <a
                href={TEL_LINK}
                aria-label={`Call Milele Motors at ${PHONE}`}
                className="flex items-center gap-2 text-white/80 hover:text-brand-blue font-medium transition-colors"
              >
            ...
            <li>
              <a
                href={`mailto:${EMAIL}`}
                className="flex items-center gap-2 text-white/80 hover:text-brand-blue font-medium transition-colors text-sm break-all"
              >
