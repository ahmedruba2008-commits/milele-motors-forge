...
const steps: Step[] = [
  {
    ...
    body: "Fill in your vehicle details in under 60 seconds. Our system instantly begins your valuation.",
  },
  {
    n: "02",
    icon: Search,
    title: "Free Expert Evaluation",
    body: "Our certified inspector visits you — or you come to us. Thorough, honest, and completely free of charge.",
  },
  {
    n: "03",
    icon: CheckCircle,
    title: "Instant Payment or Drive Away",
    body: "Sellers receive immediate payment. Buyers drive away with their new certified vehicle. No delays.",
  },
];
...
export function HowItWorks() {
  return (
    <section
      id="how-it-works"
      className="relative bg-brand-navy py-20 md:py-32 overflow-hidden text-white"
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {steps.map((s, i) => (
            <div key={s.n} className="contents">
              <div className="text-center p-4">
                <p className="text-brand-blue font-syne font-black text-sm tracking-widest mb-3">
                  {s.n}
                </p>
              ...
              {i < steps.length - 1 && (
                <div
                  className="hidden lg:grid place-items-center text-brand-blue text-4xl pt-12"
                  aria-hidden="true"
                >
                  →
                </div>
        ...
        <div className="mt-16 text-center border-t border-white/10 pt-12">
          ...
          <div className="mt-6 flex flex-col sm:flex-row justify-center gap-3">
            <a
              href="#sell-cars"
              className="bg-brand-blue hover:bg-brand-blue-dark text-white font-bold uppercase tracking-widest text-sm px-8 py-4 rounded-full shadow-lg shadow-blue-500/40 transition-all hover:-translate-y-0.5"
            >
              Get a Free Quote
            </a>
            <a
              href={TEL_LINK}
              className="bg-white/5 border border-white/20 hover:bg-white/10 text-white font-bold uppercase tracking-widest text-sm px-8 py-4 rounded-full flex items-center justify-center gap-2 transition-all"
            >
